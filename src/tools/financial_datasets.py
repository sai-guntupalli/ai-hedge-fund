...
class FinancialDatasetsProvider(DataProvider):
    def _make_api_request(self, url: str, headers: dict, method: str = "GET", json_data: dict = None, max_retries: int = 3) -> requests.Response:
        """
    ...
    def get_prices(self, ticker: str, start_date: str, end_date: str, api_key: Optional[str] = None) -> list[Price]:
    ...
    def get_financial_metrics(
        ...
        try:
            ...
            # Try to return partial data or empty
            return []
    ...
    def search_line_items(
        ...
        response = self._make_api_request(url, headers, method="POST", json_data=body)
        if response.status_code != 200:
            return []
